...
Create a tmpfs directory or store it inside /tmp to store all of your logs and results so it can get deleted upon shutdown, for extra security use keepassXC or use a LUKS drive and offline storage.
