...
print("🎯 Features:")
print("   • Reads subdirectories in reports/ and results/")
print("   • Shows directory structure with clear headers")
print("   • JSON and CSV files are foldable")
print("   • Large text files are click-to-expand")